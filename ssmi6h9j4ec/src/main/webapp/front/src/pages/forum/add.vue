<template>
	<div :style='{"alignContent":"flex-start","padding":"0 calc((100% - 1200px)/2)","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","background":"#f6f6f6","display":"flex","width":"100%","fontSize":"16px","position":"relative"}'>
		<div class="section-title" :style='{"padding":"0","margin":"20px 0 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20241228/f151b89f53c94b7fa5ae510c2f7bd563.png) no-repeat center bottom","width":"100%","fontSize":"32px","lineHeight":"100px","position":"relative","height":"191px"}'>交流论坛</div>
		<div class="back_box">
		...
		<el-form class="add-update-preview" :model="form" :rules="rules" ref="form" label-width="180px">
			...
			<el-form-item :style='{"padding":"0","textAlign":"center","margin":"20px 0"}'>
				<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","textAlign":"center","display":"inline-block","minWidth":"120px","borderRadius":"0px","background":"#3397da","width":"auto","lineHeight":"40px","fontSize":"16px","height":"40px"}' type="primary" @click="submitForm('form')">
					<span class="icon iconfont " :style='{"color":"#fff"}'></span>
					<span class="text" :style='{"color":"#fff"}'>{{this.isEdit ? '修改' : '发布帖子'}}</span>
				</el-button>
				<el-button :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","color":"#fff","textAlign":"center","display":"inline-block","minWidth":"120px","borderRadius":"0px","background":"#243559","width":"auto","lineHeight":"40px","fontSize":"16px","height":"40px"}' @click="resetForm('form')">
					<span class="icon iconfont " :style='{"color":"#fff"}'></span>
